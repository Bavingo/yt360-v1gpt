...
const PricingSection = () => {
  ...
  {/* Background glow */}
  <div className="absolute inset-0">
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] bg-primary/20 rounded-full blur-[160px]" />
  </div>
  ...
  <div className="container px-4 relative z-10">
    <div className="max-w-3xl mx-auto text-center">
      ...
      {/* Headline */}
      <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold text-primary-foreground mb-10 leading-tight">
        Comece sua jornada
        <span className="text-primary block">hoje mesmo</span>
      </h2>
