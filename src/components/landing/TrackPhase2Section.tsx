...
const TrackPhase2Section = () => {
  return (
    <section className="py-20 md:py-32 bg-foreground relative">
      {/* Animated background */}
      <div className="absolute inset-0">
        <div className="absolute -top-64 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-primary/25 rounded-full blur-[140px]" />
